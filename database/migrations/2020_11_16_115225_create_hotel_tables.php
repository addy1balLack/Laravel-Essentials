...
class CreateHotelTables extends Migration
{
    ...
    public function up()
    {
        Schema::create('room_types', function (Blueprint $table) {
            $table->id();
            $table->string('name',255)->comment('The name of the room type, ir Double Queen, etc.');
        ...
        Schema::create('rates', function (Blueprint $table){
            $table->id();
            $table->unsignedInteger('value')->comment('The rate of the room in cents');
            $table->unsignedBigInteger('room_type_id')->index('room_type_id');
        ...
        Schema::create('bookings', function (Blueprint $table){
            ...
            $table->mediumText('notes')->nullable()->comment('Any notes for the reservation');
            $table->timestamps();
            $table->softDeletes();
